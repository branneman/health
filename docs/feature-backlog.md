...
|   | 12 | **Dynamic calorie budget** — time-decay model; eating fraction learned from Polar + food history; sport/non-sport buckets; post-workout mode; wake/bedtime in onboarding        | Budget tells you "how much left *today*", not just a daily lump sum  | [dynamic-budget](dynamic-budget.md)       |
